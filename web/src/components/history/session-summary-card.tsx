  ...
  return (
    ...
    >
      <Descriptions size="small" column={{ xs: 1, sm: 2, lg: 3 }}>
        ...
        <Descriptions.Item label="下一轮">
          {metrics.canStartNextRound && metrics.nextRound
            ? `第 ${metrics.nextRound} 轮可开始`
            : "当前无需继续"}
        </Descriptions.Item>
        ...
        <Descriptions.Item label="最新进度">
          {progress
            ? `${progress.completedChunks}/${progress.totalChunks} · ${Math.round(progress.percent ?? 0)}%`
            : "—"}
        </Descriptions.Item>
      </Descriptions>
    </Card>
